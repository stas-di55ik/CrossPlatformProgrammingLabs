    ...
    public static class ClassLab1
    {
        ...
        public static List<string> getSquares()
        {
            ...
            for (int square = 0; square < 2; square++)
            {
                ...
                {
                    words.Add(new string(squares[square][row]));
                }
                words.Add(" ");
            }
        ...
        public static List<string> Execute(string inputString)
        {
            string[] splittedSrting = inputString.Split(new[] { ' ', '\n', '\r' }, StringSplitOptions.RemoveEmptyEntries);
            try
            {
                squareSize = int.Parse(splittedSrting[0]);
            ...
            Array.Copy(splittedSrting, 1, words, 0, words.Length);
